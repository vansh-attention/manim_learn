...
#define __GMP_CFLAGS "-ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem /opt/anaconda3/envs/manim_proj/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/gmp_1718980569611/work=/usr/local/src/conda/gmp-6.3.0 -fdebug-prefix-map=/opt/anaconda3/envs/manim_proj=/usr/local/src/conda-prefix"
