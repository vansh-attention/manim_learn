...
# installed.
TCL_PREFIX='/opt/anaconda3/envs/manim_proj'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/anaconda3/envs/manim_proj'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem /opt/anaconda3/envs/manim_proj/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1748387499114/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/opt/anaconda3/envs/manim_proj=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /opt/anaconda3/envs/manim_proj/include -mmacosx-version-min=11.0 -mmacosx-version-min=11.0 '
...
TCL_LD_FLAGS='-Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/opt/anaconda3/envs/manim_proj/lib -L/opt/anaconda3/envs/manim_proj/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/anaconda3/envs/manim_proj/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/anaconda3/envs/manim_proj/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/anaconda3/envs/manim_proj/include'
...
# compiled.
TCL_SRC_DIR='/opt/anaconda3/envs/manim_proj/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/opt/anaconda3/envs/manim_proj/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/anaconda3/envs/manim_proj/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/anaconda3/envs/manim_proj/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/anaconda3/envs/manim_proj/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/anaconda3/envs/manim_proj/lib/libtclstub8.6.a'
